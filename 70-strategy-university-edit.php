...
$sql = "SELECT * FROM strategy WHERE id = :strategy_id";
						...
						<div class="row gutters" id="phase">
							<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
								...
								<div class="card">
                                    ...
                                    <form class="needs-validation" action="70-script-strategy-university-update.php" method="POST" enctype="multipart/form-data" novalidate>
										<!-- Row start -->
										<div class="row gutters">
                                        <div class="col-xl-2 col-lg-2 col-md-2 col-sm-12 col-12">
												
                                        <input class="form-control" type="hidden" name="strategy_id" id="strategy_id" value="<?php echo $default['id']; ?>">
												<!-- Field wrapper start -->
												<div class="field-wrapper">
													<input class="form-control" type="number" name="strategy_code" id="strategy_code" value="<?php echo $default['code']; ?>" required>
											...
											<div class="col-xl-10 col-lg-10 col-md-10 col-sm-12 col-12">
												...
												<!-- Field wrapper start -->
												<div class="field-wrapper">
													<input class="form-control" type="text" name="strategy_name" id="strategy_name" value="<?php echo $default['name']; ?>" required>
