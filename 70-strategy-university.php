...
<body>
                ...
                <div class="content-wrapper">
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="card-title">บันทึกแผนยุทธศาสตร์ (มหาวิทยาลัย)</div>
                                </div>
                                <div class="card-body">

                                    <form class="needs-validation" action="70-script-strategy-university-insert.php" method="POST" enctype="multipart/form-data" novalidate>
                                        <!-- Row start -->
                    ...
                    <div class="row gutters">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                <div class="card-header">
                                    <div class="card-title">ตารางข้อมูลแผนยุทธศาสตร์</div>
    ...
    <script>
        ...
        function _editPlan(id) {
            window.location = '70-strategy-university-edit.php?strategy_id=' + id;
        }
        ...
        function _delPlan(id) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        type: "POST",
                        url: "70-script-strategy-university-delete.php",
                        data: {
                            id: id
                        },
        ...
        function webreload() {
            window.location = '70-strategy-university.php';
        }
    </script>
